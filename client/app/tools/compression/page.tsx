...
const compressionTools = [
  {
    ...
    description:
      "Reduce the file size of your images without compromising quality.",
    icon: FileImage,
  ...
  },
  {
    ...
    description:
      "Compress PDF files to reduce their size while maintaining readability.",
    icon: FileText,
          ...
          >
            <div className="container mx-auto px-4 text-center">
              ...
              <motion.p
                ...
                variants={fadeInUp}
              >
                Choose a compression tool above to get started, or explore our
                other services.
              </motion.p>
