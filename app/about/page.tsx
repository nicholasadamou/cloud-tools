                ...
                <motion.div variants={fadeInUp} transition={{ delay: 0.8 }}>
                  <Card>
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-muted-foreground">We put our users first in everything we do, constantly seeking feedback and improving our tools to meet their needs.</p>
                    </CardContent>
                  </Card>
                </motion.div>
          ...
          >
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl mb-10 opacity-90">Join thousands of satisfied users and experience the power of Cloud Tools today.</p>
